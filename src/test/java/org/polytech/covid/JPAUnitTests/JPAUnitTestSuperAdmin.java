 ...
 * 
 * assertThat(admin.getPersonne().getIdentifiant()).isEqualTo(personne.
 * getIdentifiant());
 ...
 * assertThat(admin.getPersonne().getTelephone()).isEqualTo(personne.
 * getTelephone());
 ...
 * assertThat(admin.getCentre().getHorairesLundi()).isEqualTo(centre.
 * getHorairesLundi());
 * assertThat(admin.getCentre().getHorairesMardi()).isEqualTo(centre.
 * getHorairesMardi());
 * assertThat(admin.getCentre().getHorairesMercredi()).isEqualTo(centre.
 * getHorairesMercredi());
 * assertThat(admin.getCentre().getHorairesJeudi()).isEqualTo(centre.
 * getHorairesJeudi());
 * assertThat(admin.getCentre().getHorairesVendredi()).isEqualTo(centre.
 * getHorairesVendredi());
 * assertThat(admin.getCentre().getHorairesSamedi()).isEqualTo(centre.
 * getHorairesSamedi());
 * assertThat(admin.getCentre().getHorairesDimanche()).isEqualTo(centre.
 * getHorairesDimanche());
 * }
 * 
 * @Test
