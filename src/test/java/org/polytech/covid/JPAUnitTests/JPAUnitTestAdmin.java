 ...
 * Personne personne = personneRepository.save(new Personne("NomPersonne",
 * "PrenomPersonne",
 * "mail.personne@mail.com", "+33111111111", "1, adresse de la personne",
 * "mdp"));
 * 
 * Centre centre = centreRepository.save(new Centre("Test Centre", "Baccarat",
 * "1", "rue de Baccarat",
 * 54120,
 * "9h00-12h00/14h-18h", "9h00-12h00/14h-18h", "9h00-12h00/14h-18h",
 * "9h00-12h00/14h-18h",
 * "9h00-12h00/14h-18h", "8h00-13h00", "fermé"));
 * 
 * Medecin medecin = medecinRepository.save(new Medecin(personne, centre));
 * 
 * assertThat(medecin.getPersonne().getIdentifiant()).isEqualTo(personne.
 * getIdentifiant());
 ...
 * assertThat(medecin.getPersonne().getTelephone()).isEqualTo(personne.
 * getTelephone());
 ...
 * assertThat(medecin.getCentre().getNumAdresse()).isEqualTo(centre.
 * getNumAdresse());
 ...
 * assertThat(medecin.getCentre().getHorairesLundi()).isEqualTo(centre.
 * getHorairesLundi());
 * assertThat(medecin.getCentre().getHorairesMardi()).isEqualTo(centre.
 * getHorairesMardi());
 * assertThat(medecin.getCentre().getHorairesMercredi()).isEqualTo(centre.
 * getHorairesMercredi());
 * assertThat(medecin.getCentre().getHorairesJeudi()).isEqualTo(centre.
 * getHorairesJeudi());
 * assertThat(medecin.getCentre().getHorairesVendredi()).isEqualTo(centre.
 * getHorairesVendredi());
 * assertThat(medecin.getCentre().getHorairesSamedi()).isEqualTo(centre.
 * getHorairesSamedi());
 * assertThat(medecin.getCentre().getHorairesDimanche()).isEqualTo(centre.
 * getHorairesDimanche());
 * }
 * 
 * @Test
 * public void should_find_all_medecins() {
 * Personne personne1 = personneRepository.save(new Personne("NomPersonne1",
 * "PrenomPersonne1",
 * "mail.personne1@mail.com", "+33111111111", "1, adresse de la personne 1",
 * "mdp1"));
 * 
 * Personne personne2 = personneRepository.save(new Personne("NomPersonne2",
 * "PrenomPersonne2",
 * "mail.personn2@mail.com", "+33222222222", "2, adresse de la personne 2",
 * "mdp2"));
 * 
 * Personne personne3 = personneRepository.save(new Personne("NomPersonne3",
 * "PrenomPersonne3",
 * "mail.personn3@mail.com", "+33333333333", "3, adresse de la personne 3",
 * "mdp3"));
 * 
 * Centre centre1 = centreRepository.save(new Centre("Test Centre 1",
 * "Baccarat", "1", "rue de Baccarat",
 * 54120,
 * "9h00-12h00/14h-18h", "9h00-12h00/14h-18h", "9h00-12h00/14h-18h",
 * "9h00-12h00/14h-18h",
 * "9h00-12h00/14h-18h", "8h00-13h00", "fermé"));
 * 
 * Centre centre2 = centreRepository.save(new Centre("Test Centre 2",
 * "Baccarat", "2", "rue de Baccarat",
 * 54120,
 * "9h00-12h00/14h-18h", "9h00-12h00/14h-18h", "9h00-12h00/14h-18h",
 * "9h00-12h00/14h-18h",
 * "9h00-12h00/14h-18h", "8h00-13h00", "fermé"));
 * 
 * Centre centre3 = centreRepository.save(new Centre("Test Centre 3",
 * "Jarville", "3", "rue de Jarville",
 * 54140,
 * "9h00-12h00/14h-18h", "9h00-12h00/14h-18h", "9h00-12h00/14h-18h",
 * "9h00-12h00/14h-18h",
 ...
 * 
 * Medecin checkMedecin =
 * medecinRepository.findById(medecin1.getId_medecin()).get();
 * 
