 ...
 * .save(new Personne("testNom", "testPrenom", "testMail", "testTelephone",
 * "testAdresse", "mdp"));
 ...
 * Reservation reservation = reservationRepository.save(new
 * Reservation(testDate, personne, centre));
 * assertThat(reservation).hasFieldOrPropertyWithValue("date_reservation",
 * testDate);
