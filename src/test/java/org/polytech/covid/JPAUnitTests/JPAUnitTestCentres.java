 ...
 * assertThat(centre).hasFieldOrPropertyWithValue("horairesLundi",
 * "9h00-12h00/14h-18h");
 * assertThat(centre).hasFieldOrPropertyWithValue("horairesMardi",
 * "9h00-12h00/14h-18h");
 * assertThat(centre).hasFieldOrPropertyWithValue("horairesMercredi",
 * "9h00-12h00/14h-18h");
 * assertThat(centre).hasFieldOrPropertyWithValue("horairesJeudi",
 * "9h00-12h00/14h-18h");
 * assertThat(centre).hasFieldOrPropertyWithValue("horairesVendredi",
 * "9h00-12h00/14h-18h");
 * assertThat(centre).hasFieldOrPropertyWithValue("horairesSamedi",
 * "8h00-13h00");
 ...
 * "9h00-12h00/14h-18h", "8h00-13h00", "fermé"));
 * 
 * Centre updatedCentre = new Centre("updated Centre 1", "Baccarat", "1",
 * "rue de Baccarat updated", 54120,
 * "9h00-12h00/14h-18h", "9h00-12h00/14h-18h", "9h00-12h00/14h-18h",
 * "9h00-12h00/14h-18h",
 ...
 * assertThat(checkCentre.getHorairesLundi()).isEqualTo(updatedCentre.
 * getHorairesLundi());
 * assertThat(checkCentre.getHorairesMardi()).isEqualTo(updatedCentre.
 * getHorairesMardi());
 * assertThat(checkCentre.getHorairesMercredi()).isEqualTo(updatedCentre.
 * getHorairesMercredi());
 * assertThat(checkCentre.getHorairesJeudi()).isEqualTo(updatedCentre.
 * getHorairesJeudi());
 * assertThat(checkCentre.getHorairesVendredi()).isEqualTo(updatedCentre.
 * getHorairesVendredi());
 * assertThat(checkCentre.getHorairesSamedi()).isEqualTo(updatedCentre.
 * getHorairesSamedi());
 * assertThat(checkCentre.getHorairesDimanche()).isEqualTo(updatedCentre.
 * getHorairesDimanche());
 * }
 * 
 * @Test
